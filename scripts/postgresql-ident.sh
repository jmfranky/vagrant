...
# https://raw.githubusercontent.com/Mullen/vagrant/master/scripts/postgresql-ident.sh
...
hash psql 2>/dev/null || {
  ...
  sudo -u postgres psql 2>/dev/null -c "alter user postgres with password 'postgres'" > /dev/null 2>&1
